...
params_out.k_out_PDL1  = params_in.k_out_PDL1;
params_out.k_in_PDL1  = params_in.k_in_PDL1;
params_out.r_PDL1_IFNg  = params_in.r_PDL1_IFNg;
...
params_out.kon_PDL1_atezo = params_in.kon_PDL1_atezo ;
...
params_out.kon_PDL1_atezo.Notes = ['kon for PDL1-atezolizumab ' params_in.kd_PDL1_atezo.Notes];
% koff Values
...
params_out.koff_PDL1_atezo = params_in.kon_PDL1_atezo * params_in.kd_PDL1_atezo;
...
params_out.koff_PDL1_atezo.Notes = ['calculated based on the measured kd and kon ' params_in.kd_PDL1_atezo.Notes];
...
params_out.Chi_PDL1_atezo = params_in.Chi_PDL1_atezo/(params_in.d_syn*params_in.N_avg);
params_out.Chi_PDL1_atezo.Notes = [' that also includes the conversion of kon from 3D to 2D' params_in.Chi_PDL1_atezo.Notes];
...
if Cname(1)=='C'
    ...
    params_out.(['r_PDL2',Cname]) = params_in.r_PDL2C;
...
elseif Cname(1)=='A'
    ...
    params_out.(['r_PDL2',Cname]) = params_in.r_PDL2APC;
